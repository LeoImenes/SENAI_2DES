var table = document.getElementsByClassName(".cadastro").value();
//var table = <tbody id="data"></tbody>;

//Documento
var nome = document.querySelector("#nome");
//Nome
var endereco = document.querySelector("#enderco");
//Turma
...
function cadastrar() {
    ...
    um linha a tabela*/
    if(btn_add.innerHTML === "Adicionar Pedido") {
       
        let cadastrado = false;
                // 0     1     2     
        let data = [nome.value, endereco.value, lanche.value];
